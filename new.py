...
def display_points_math():
    math_p = display_final_math_sem1()
    cal_p = Calculation(math_p)
    cal_math_tot_credit = credit_math * cal_p
    return cal_math_tot_credit
def display_points_physics():
    phy_p = display_final_physics_sem1()
    cal_phy_p = Calculation(phy_p)
    cal_phy_tot_credit = credit_physics * cal_phy_p
    return cal_phy_tot_credit
def display_points_BEE():
    BEE_p = display_final_BEE_sem1()
    cal_phy_p = Calculation(BEE_p)
    cal_phy_tot_credit = credit_BEE * cal_phy_p
    return cal_phy_tot_credit
def display_points_BEE_lab():
    BEE_p = display_final_BEElab_sem1()
    cal_phy_p = Calculation(BEE_p)
    cal_phy_tot_credit = credit_BEE_lab * cal_phy_p
    return cal_phy_tot_credit
def display_points_physics_lab():
    BEE_p = display_final_physicslab_sem1()
    cal_phy_p = Calculation(BEE_p)
    cal_phy_tot_credit = credit_physics_lab * cal_phy_p
    return cal_phy_tot_credit
def display_points_workprac_lab():
    BEE_p = display_final_workshoppractical_sem1()
    cal_phy_p = Calculation(BEE_p)
    cal_phy_tot_credit = credit_workprac * cal_phy_p
    return cal_phy_tot_credit
...
def display_grade_math():
    math_p = display_final_math_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
def display_grade_physics():
    math_p = display_final_physics_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
def display_grade_BEE():
    math_p = display_final_BEE_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
def display_grade_BEE_lab():
    math_p = display_final_BEElab_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
def display_grade_physics_lab():
    math_p = display_final_physicslab_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
def display_grade_workprac_lab():
    math_p = display_final_workshoppractical_sem1()
    cal_p = Calculation_grade(math_p)
    return cal_p
#     l3 = Label(base, text=str(cal_p))
#     l3.place(x=500, y=460)
#
#
# button4 = Button(base, text="Calculate", bg="green", command=display_grade_workprac_lab)
# button4.place(x=540, y=460)
